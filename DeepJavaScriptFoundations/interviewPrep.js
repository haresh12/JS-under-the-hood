 ...
 *   PROMISE.ALL : IF ANY OF PROMISED FAILD THEN NO RESULT WILL BE GIVEN
 */

/**
 *  LIST OF ES6 FEATURE THAT I USE MOSTLY
 *
 *   ARROW FUNCTION
 *   DESTRUCTING
 *   SPREAD OPREATOR
 *   REST OPRETOR
 *   TEMPLET STRING
 *   CLASSES (ENTIRE OBJECT ORIENTED PROGRAMING CAME INTO PICTURE AFTER ES6)
 *   OBJECT SHORTEN : YOU KNOW WHEN YOU HAVE SAME KEY AND VALUE NAME THEN YOU DON'T NEED TO WRITE BOTH JUST WRITE KEY
 *   LET AND CONST  (THIS SHOULD BE TOP)
 *   ITTORATOR AND GENERATORS
 *   DEFALUT PARAM VALUE
 *
 */
